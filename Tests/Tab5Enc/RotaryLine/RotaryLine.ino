 ...
 *   - Encoder Unit I2C-Adresse: 0x40.
 *   - M5GFX >= 0.2.20 erforderlich (DSI-Bugfix für Tab5).
 *   - Bibliotheken: M5GFX, M5Unit-Encoder
 */
...
int16_t  prev_enc    = 0;       // Letzter Encoder-Wert (für Delta-Berechnung)
...
void setup() {
  ...
  prev_enc = encoder.getEncoderValue();
}

void loop() {
  int16_t enc   = encoder.getEncoderValue();
